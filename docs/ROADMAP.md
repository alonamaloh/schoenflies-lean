...
1. the stage recursion — both directions of `thm:finite-transfer` are implemented.  A bare
   ...
   edge-dichotomy obligations.  Its remaining assembly facts are 2-connectivity, connectedness
   off the model curve, and the fresh boundary-incidence condition needed by reverse transfer.
